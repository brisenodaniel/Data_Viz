...
The overall higher averages on weekends than weekday may be attributed to, aside from drinking, larger parties or more expensive means on weekends. Both of these contribute to larger total bills, which as we saw in our previous research question in our initial analysis, larger bill equate to larger tips.

Ultimately, as a server, if you are looking at the opportunity to make high tips while still guaranteeing a decent tip, Sunday night would be best, followed by Friday night. However, if you are looking for consistency in tipping, you will want to be scheduled for Thursday night or Saturday day as the spread is much tighter, but the median is much higher.
